...
export default function Dashboard() {
  ...
  async function handleSetMood(mood) {
    ...
    try {
      // have data structure created if not exist
      ...
      const res = await setDoc(
        docRef,
        {
          // as they need to be dynamic variables using square brackets
          [year]: {
            [month]: {
              [day]: mood,
            },
        ...
        { merge: true } // merge this info with current info and not replace
      );
    } catch (err) {
